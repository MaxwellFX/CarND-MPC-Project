...
class FG_eval
{
  public:
    ...
    void operator()(ADvector &fg, const ADvector &vars)
    {
        ...
        const double v_weight = 2.6;
        const double actuator_weight = 5;
        const double speed_turn_weight = 1100;
        const double steering_weight = 300;
        const double acceleration_weight = 15;
